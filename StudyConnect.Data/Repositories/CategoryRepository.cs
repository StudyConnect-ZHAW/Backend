...
public class CategoryRepository : BaseRepository, ICategoryRepository
{
    ...
    public async Task<OperationResult<ForumCategory?>> GetByIdAsync(Guid categoryId)
    {
        ...
        var category = await _context.ForumCategories
            .AsNoTracking()
            .FirstOrDefaultAsync(c => c.ForumCategoryId == categoryId);
    ...
    public async Task<OperationResult<ForumCategory?>> GetByNameAsync(string categoryName)
    {
        if (categoryName == null)
            return OperationResult<ForumCategory?>.Failure("Invalid category name.");
